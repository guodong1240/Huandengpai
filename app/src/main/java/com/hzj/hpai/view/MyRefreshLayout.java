...
/**
 * Created by zx on 16/6/24.
 */
public class MyRefreshLayout extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    public static boolean Mode_up = false;
    public static boolean Mode_both = true;
    ...
    private boolean canLoad() {
        return isBottom() && !isLoading && isPullUp() && isMode() && !isRefreshing();
    }
